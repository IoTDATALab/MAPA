    ...
    for epoch in range(EPOCH):
        ...
        for step, (b_x, b_y) in enumerate(train_loader):
            ...
            if step % TEST_NUM == 0:
                ...
                man_file1 = open(RESULT_ROOT + '[' + str(EDGE_NAME) + ']' + '[FixDP-Accuracy]', 'w')
                accuracy = correct / total
                acc.append(accuracy)
                print(acc, file=man_file1)
                man_file1.close()

                man_file2 = open(RESULT_ROOT + '[' + str(EDGE_NAME) + ']' + '[FixDP-TestLoss]', 'w')
                test_loss = test_loss / (i + 1)
                Losstest.append(test_loss)
                print(Losstest, file=man_file2)
                man_file2.close()

                man_file3 = open(RESULT_ROOT + '[' + str(EDGE_NAME) + ']' + '[FixDP-TrainLoss]', 'w')
