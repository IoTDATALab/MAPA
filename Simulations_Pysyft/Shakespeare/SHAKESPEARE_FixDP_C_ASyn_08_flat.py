...
vis = Visdom(env='Shakes_FixDP_C_ASyn_08flat')
...
######## Logging files #######
with open('../results/SHAKESPEARE/FixDP_C_Asyn_08flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/SHAKESPEARE/FixDP_C_Asyn_08flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {})'.
             format(date, args.users_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound))
    fl.write(str(test_acc) + '\t')
with open('../results/SHAKESPEARE/FixDP_C_Asyn_08flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {})'.
             format(date, args.users_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound))
with open('../results/SHAKESPEARE/FixDP_C_Asyn_08flat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {})'.
             format(date, args.users_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound))
