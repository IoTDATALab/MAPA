...
vis = Visdom(env='Shakes_AdaClip2_ASyn_08flat')
...
class Arguments():
    def __init__(self):
        ...
        self.quatile = 0.8   # Target unclipped gradient
...
models = {}
optims = {}
Users_num_total, Ratio = Virtual_Users_num(Leaf_split, LEAF=args.Leaf, Skew=args.Skew)
...
######## Logging files #######
with open('../results/SHAKESPEARE/AdaClip2_Asyn_08fat_TestLoss.txt', 'a+') as fl:
...
with open('../results/SHAKESPEARE/AdaClip2_Asyn_08fat_TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {}) \n'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SHAKESPEARE/AdaClip2_Asyn_08fat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {}) \n'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
with open('../results/SHAKESPEARE/AdaClip2_Asyn_08fat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {}) \n'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
