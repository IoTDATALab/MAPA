...
date = datetime.now().strftime('%Y-%m-%d %H:%M')
# vis = Visdom(env='Shakes_NonDP_ASyn')
...
# Load train dataset
train_loader = Datasets.Shakespeare(data_root_train, user_size=args.users_total)#训练集载入
...
# Logging files
with open('../results/SHAKESPEARE/NonDP_Asyn_TestLoss.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {})'.
             format(date, args.users_total, args.user_sel_prob, args.batch_size, args.lr, args.z))
    fl.write(str(test_loss) + '\t')
with open('../results/SHAKESPEARE/NonDP_Asyn_TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {})'.
             format(date, args.users_total, args.user_sel_prob, args.batch_size, args.lr, args.z))
    fl.write(str(test_acc) + '\t')
with open('../results/SHAKESPEARE/NonDP_Asyn_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {})'.
             format(date, args.users_total, args.user_sel_prob, args.batch_size, args.lr, args.z))
...
# Results_testacc = vis.line(np.array([test_acc.data.numpy()]), [1], win='Test_acc',
...
for itr in range(1, args.itr_numbers + 1):
    ...
    # print('iteration: ', itr, 'Users_num_total: ', Users_num_total, 'Users_Current: ', Users_Current)
