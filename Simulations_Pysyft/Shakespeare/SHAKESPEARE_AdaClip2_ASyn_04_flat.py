...
vis = Visdom(env='Shakes_AdaClip2_ASyn_04flat')
...
######## Logging files #######
with open('../results/SHAKESPEARE/AdaClip2_Asyn_04flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/SHAKESPEARE/AdaClip2_Asyn_04flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {}) \n'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SHAKESPEARE/AdaClip2_Asyn_04flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {}) \n'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
with open('../results/SHAKESPEARE/AdaClip2_Asyn_04flat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {}) \n'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
