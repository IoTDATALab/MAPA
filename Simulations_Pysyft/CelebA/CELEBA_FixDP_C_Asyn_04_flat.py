...
vis = Visdom(env='CELEBA_FixDP_C_Asyn_04_flat')
...
with open('../results/CELEBA/FixDP_C_Asyn_04flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/CELEBA/FixDP_C_Asyn_04flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
with open('../results/CELEBA/FixDP_C_Asyn_04flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
with open('../results/CELEBA/FixDP_C_Asyn_04flat_Budget.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
