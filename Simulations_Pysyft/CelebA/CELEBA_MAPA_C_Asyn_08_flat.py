...
vis = Visdom(env='CELEBA_MAPA_C_Asyn_08_flat')
...
with open('../results/CELEBA/MAPA_C_Asyn_08flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/CELEBA/MAPA_C_Asyn_08flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n ' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, z is {}, {}, CB is {}'.format(args.batch_size, args.z, args.ClipStyle, args.grad_upper_bound))
    fl.write(', L is {}, inital bound is {} \n'.format(args.L_smooth, args.inital_bound))
with open('../results/CELEBA/MAPA_C_Asyn_08flat_Budget.txt', 'a+') as fl:
    fl.write('\n ' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, z is {}, {}, CB is {}'.format(args.batch_size, args.z, args.ClipStyle, args.grad_upper_bound))
    fl.write(', L is {}, inital bound is {} \n'.format(args.L_smooth, args.inital_bound))
with open('../results/CELEBA/MAPA_C_Asyn_08flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n ' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, z is {}, {}, CB is {}'.format(args.batch_size, args.z, args.ClipStyle, args.grad_upper_bound))
    fl.write(', L is {}, inital bound is {} \n'.format(args.L_smooth, args.inital_bound))
