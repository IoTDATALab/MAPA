...
vis = Visdom(env='CELEBA_FixDP_S_Asyn_08_flat')
...
with open('../results/CELEBA/FixDP_S_Asyn_08flat__TestLoss.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z,args.ClipStyle, args.grad_upper_bound))
with open('../results/CELEBA/FixDP_S_Asyn_08flat__TestAcc.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
with open('../results/CELEBA/FixDP_S_Asyn_08flat__TrainLoss.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
with open('../results/CELEBA/FixDP_S_Asyn_08flat__Budget.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
...
def modelSave():
    dir = "./model/FixDP_S_08_flat/"+'lr'+str(args.lr)+'z'+str(args.z)+'CB'+str(args.grad_upper_bound)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
