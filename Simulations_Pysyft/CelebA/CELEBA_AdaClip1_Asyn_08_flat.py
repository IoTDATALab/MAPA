...
vis = Visdom(env='CELEBA_AdaClip1_Asyn_08_flat')
...
with open('../results/CELEBA/AdaClip1_Asyn_08flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/CELEBA/AdaClip1_Asyn_08flat_Budget.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', batch_size is {}, learning rate is {}, ClipBound is {}, z is {}, {},'
             .format(args.batch_size, args.lr, args.ClipBound, args.z, args.ClipStyle))
    fl.write(', beta1 is {}, beta2 is {}, h1 is {}, h2 is {}, itr_number is {}, log_test is {}, log_train is {} \n'
...
with open('../results/CELEBA/AdaClip1_Asyn_08flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n %' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', batch_size is {}, learning rate is {}, ClipBound is {}, z is {}, {},'
             .format(args.batch_size, args.lr, args.ClipBound, args.z, args.ClipStyle))
    fl.write(', beta1 is {}, beta2 is {}, h1 is {}, h2 is {}, itr_number is {}, log_test is {}, log_train is {} \n'
...
with open('../results/CELEBA/AdaClip1_Asyn_08flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', batch_size is {}, learning rate is {}, ClipBound is {}, z is {}, {},'
             .format(args.batch_size, args.lr, args.ClipBound, args.z, args.ClipStyle))
    fl.write(', beta1 is {}, beta2 is {}, h1 is {}, h2 is {}, itr_number is {}, log_test is {}, log_train is {} \n'
