...
Sampled_ratio = args.user_sel_prob#抽样比例，用于计算隐私预算
...
with open('../results/CELEBA/FixDP_C_Asyn_08flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/CELEBA/FixDP_C_Asyn_08flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
with open('../results/CELEBA/FixDP_C_Asyn_08flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
with open('../results/CELEBA/FixDP_C_Asyn_08flat_Budget.txt', 'a+') as fl:
    fl.write('\n%' + date + ' Results (Total users number is ' + str(args.users_total))
    fl.write(', BZ is {}, lr is {}, z is {},{}, CB is {}\n'
             .format(args.batch_size, args.lr, args.z, args.ClipStyle, args.grad_upper_bound))
