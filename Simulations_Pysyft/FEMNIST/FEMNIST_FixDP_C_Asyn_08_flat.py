...
vis = Visdom(env='FEMNIST_FixDP_C_Asyn_08_flat')
...
with open('../results/FEMNIST/FixDP_C_Asyn_08flat__TestLoss.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound, args.ClipStyle))
with open('../results/FEMNIST/FixDP_C_Asyn_08flat__TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound, args.ClipStyle))
with open('../results/FEMNIST/FixDP_C_Asyn_08flat__TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound, args.ClipStyle))
with open('../results/FEMNIST/FixDP_C_Asyn_08flat__Budget.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound, args.ClipStyle))
...
def modelSave():
    dir = "./model/FixDP_C_08_flat/"+'lr'+str(args.lr)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
