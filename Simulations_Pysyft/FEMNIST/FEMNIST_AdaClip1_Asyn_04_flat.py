...
vis = Visdom(env='FEMNIST_AdaClip1_Asyn_04_flat')
...
Leaf_split = train_loader.num_samples #O riginal split provided by LEAF
...
with open('../results/FEMNIST/AdaClip1_Asyn_04flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/FEMNIST/AdaClip1_Asyn_04flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound,args.ClipStyle))
with open('../results/FEMNIST/AdaClip1_Asyn_04flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound, args.ClipStyle))
with open('../results/FEMNIST/AdaClip1_Asyn_04flat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound, args.ClipStyle))
...
def modelSave():
    dir = "./model/AdaClip1_04_flat/"+'lr'+str(args.lr)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
