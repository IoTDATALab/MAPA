...
vis = Visdom(env='FEMNIST_FixDP_S_Asyn_04_flat')
...
with open('../results/FEMNIST/FixDP_S_Asyn_04flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/FEMNIST/FixDP_S_Asyn_04flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {}) \n '.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound, args.ClipStyle))
with open('../results/FEMNIST/FixDP_S_Asyn_04flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {}) \n '.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound, args.ClipStyle))
with open('../results/FEMNIST/FixDP_S_Asyn_04flat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {}) \n '.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound, args.ClipStyle))
...
def modelSave():
    dir = "./model/FixDP_S_04_flat/"+'lr'+str(args.lr)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
