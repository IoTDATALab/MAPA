...
vis = Visdom(env='FEMNIST_MAPA_S_Asyn_08_flat')
...
class Arguments():
    def __init__(self):
        ...
        self.lr = 1 # Learning rate, is adaptively adjusted
        self.L_smooth = 0.000004   # L smooth constant of gradient
...
#Load train datasets
train_loader = Datasets.Femnist(data_root_train, user_size=args.users_total)#训练集载入
...
with open('../results/FEMNIST/MAPA_S_Asyn_08flat_TestLoss.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, SNR is {}, CB is {}, smooth is {}, itr_number is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.z, args.grad_upper_bound, args.L_smooth, args.itr_numbers, args.ClipStyle))

with open('../results/FEMNIST/MAPA_S_Asyn_08flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n %{} Results  (UN is {}, SP is {}, BZ is {}, SNR is {}, CB is {}, smooth is {}, itr_number is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.z, args.grad_upper_bound,args.L_smooth,args.itr_numbers, args.ClipStyle))

with open('../results/FEMNIST/MAPA_S_Asyn_08flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, SNR is {}, CB is {}, smooth is {}, itr_number is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.z, args.grad_upper_bound, args.L_smooth, args.itr_numbers, args.ClipStyle))
with open('../results/FEMNIST/MAPA_S_Asyn_08flat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, SNR is {}, CB is {}, smooth is {}, itr_number is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.z, args.grad_upper_bound, args.L_smooth, args.itr_numbers, args.ClipStyle))
...
def modelSave():
    dir = "./model/MAPA_S_08_flat/"+'lr'+str(args.lr)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
