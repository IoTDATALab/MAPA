...
vis = Visdom(env='FEMNIST_AdaClip2_Asyn_04flat')
...
####################### Define Clipping #######################
def TensorClip(Tensor, ClipBound, normShow):
    norm = torch.tensor([0.])
...
for itr in range(1, args.itr_numbers + 1):
    ...
    for idx_outer, (train_data, train_targets) in enumerate(federated_train_loader):
        ...
        # Model clipping
        normShow = False
        ModelVary_Tensor, Indicator = TensorClip(ModelVary_Tensor, Clip_Bound, normShow)
    ...
    Collect_Models = AddNoise_to_Model(Collect_Models, Clip_Bound, args)  # Noise injecting
    # Average indicators
...
with open('../results/FEMNIST/AdaClip2_Asyn_04flat__TestLoss.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound))
with open('../results/FEMNIST/AdaClip2_Asyn_04flat__TestAcc.txt', 'a+') as fl:
    fl.write('\n %{} Results  (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {},{})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound,args.ClipStyle))
with open('../results/FEMNIST/AdaClip2_Asyn_04flat__TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound))
with open('../results/FEMNIST/AdaClip2_Asyn_04flat__Budget.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound))

with open('../results/FEMNIST/AdaClip2_Asyn_04flat__TrainLoss.txt', 'a+') as fl:
    fl.write('\n train_loss: ' + str(logs['train_loss']))
with open('../results/FEMNIST/AdaClip2_Asyn_04flat__TestLoss.txt', 'a+') as fl:
    fl.write('\n test_loss: ' + str(logs['test_loss']))
with open('../results/FEMNIST/AdaClip2_Asyn_04flat__TestAcc.txt', 'a+') as fl:
    fl.write('\n test_acc: ' + str(logs['test_acc']))
with open('../results/FEMNIST/AdaClip2_Asyn_04flat__Budget.txt', 'a+') as fl:
    fl.write('\n varepsilon: ' + str(logs['varepsilon']))

def modelSave():
    dir = "./model/AdaClip2_04_flat/"+'lr'+str(args.lr)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
