...
vis = Visdom(env='FEMNIST_MAPA_C_Asyn_04_flat')
...
with open('../results/FEMNIST/MAPA_C_Asyn_04flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/FEMNIST/MAPA_C_Asyn_04flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n %{} Results  (UN is {}, SP is {}, BZ is {}, SNR is {}, CB is {}, smooth is {}, itr_number is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.z, args.grad_upper_bound,args.L_smooth,args.itr_numbers, args.ClipStyle))

with open('../results/FEMNIST/MAPA_C_Asyn_04flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, SNR is {}, CB is {}, smooth is {}, itr_number is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.z, args.grad_upper_bound, args.L_smooth, args.itr_numbers, args.ClipStyle))
with open('../results/FEMNIST/MAPA_C_Asyn_04flat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, SNR is {}, CB is {}, smooth is {}, itr_number is {}, {})\n'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.z, args.grad_upper_bound, args.L_smooth, args.itr_numbers, args.ClipStyle))
...
def modelSave():
    dir = "./model/MAPA_C_04_flat/"+'lr'+str(args.lr)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
