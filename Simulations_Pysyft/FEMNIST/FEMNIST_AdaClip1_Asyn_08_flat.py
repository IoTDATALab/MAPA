...
vis = Visdom(env='FEMNIST_AdaClip1_Asyn_08_flat')
...
with open('../results/FEMNIST/AdaClip1_Asyn_08flat_TestLoss.txt', 'a+') as fl:
...
with open('../results/FEMNIST/AdaClip1_Asyn_08flat_TestAcc.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound,args.ClipStyle))
with open('../results/FEMNIST/AdaClip1_Asyn_08flat_TrainLoss.txt', 'a+') as fl:
    fl.write('\n {} Results  (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound, args.ClipStyle))
with open('../results/FEMNIST/AdaClip1_Asyn_08flat_Budget.txt', 'a+') as fl:
    fl.write('\n {} Results (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, {})'.
             format(date, args.users_total, args.user_sel_prob, batch_size, args.lr, args.z, args.ClipBound, args.ClipStyle))
...
def modelSave():
    dir = "./model/AdaClip1_08_flat/"+'lr'+str(args.lr)+'bz'+str(args.batch_size)+'itr'+str(args.itr_numbers)
