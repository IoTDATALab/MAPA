...
# vis = Visdom(env='SYNTHETIC_FixDP_C_Asyn_04flat')
...
with open('../results/SYNTHETIC/FixDP_C_Asyn_TestLoss_04flat.txt', 'a+') as fl:
...
with open('../results/SYNTHETIC/FixDP_C_Asyn_TestAcc_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.clipbound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SYNTHETIC/FixDP_C_Asyn_TrainLoss_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.clipbound,
                    args.ClipStyle, args.Leaf))
with open('../results/SYNTHETIC/FixDP_C_Asyn_Budget_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.clipbound,
                    args.ClipStyle, args.Leaf))
