...
# vis = Visdom(env='SYNTHETIC_MAPA_ASyn')
...
class Arguments():
    def __init__(self):
        ...
        self.L_smooth = 0.03   # L smooth constant of gradient
...
def Stage_Lr_Itrs(grad_upper_bound, Layers_nodes):
    ...
    Delta_b = args.grad_var**2 / args.batch_size + sum(Layers_nodes) * (args.z * grad_upper_bound)**2 / args.batch_size
    # Average delay
...
with open('../results/SYNTHETIC/MAPA_C_Asyn_TestLoss_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, L is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.L_smooth, Stage_Lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_loss) + '\t')
with open('../results/SYNTHETIC/MAPA_C_Asyn_TestAcc_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, L is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.L_smooth, Stage_Lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SYNTHETIC/MAPA_C_Asyn_TrainLoss_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, L is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.L_smooth, Stage_Lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
with open('../results/SYNTHETIC/MAPA_C_Asyn_Budget_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, L is {}, LR is{}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.L_smooth, Stage_Lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
...
for itr in range(1, args.itr_numbers + 1):
    ...
    if itr >= Stage_Itr_count:
        ...
        Stage_Lr, Stage_Itr_current = Stage_Lr_Itrs(Clip_Bound, Layers_nodes)
