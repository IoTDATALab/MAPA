...
# vis = Visdom(env='SYNTHETIC_FixDP_C_Asyn_08flat')
...
models = {}
optims = {}
Users_num_total, Ratio = Virtual_Users_num(Leaf_split, LEAF=0)
...
with open('../results/SYNTHETIC/FixDP_C_Asyn_TestLoss_08flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, SK is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.Skew, args.ClipStyle, args.Leaf))
    fl.write(str(test_loss) + '\t')
with open('../results/SYNTHETIC/FixDP_C_Asyn_TestAcc_08flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, SK is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.Skew, args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SYNTHETIC/FixDP_C_Asyn_TrainLoss_08flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, SK is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.Skew, args.ClipStyle, args.Leaf))
with open('../results/SYNTHETIC/FixDP_C_Asyn_Budget_08flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, SK is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.Skew, args.ClipStyle, args.Leaf))
...
for itr in range(1, args.itr_numbers + 1):
    ...
    for idx_outer, (train_data, train_targets) in enumerate(federated_train_loader):
        ...
        Collect_Gradients = AddNoise(Collect_Gradients, Clip_Bound)  # Add noises
