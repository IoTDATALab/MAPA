...
# vis = Visdom(env='SYNTHETIC_AdaClip2_ASyn_04flat')
...
class Arguments():
    def __init__(self):
        ...
        self.c = torch.tensor([0.3])  # Split ratio of privacy budget
        self.quatile = 0.9   # Target unclipped gradient
...
with open('../results/SYNTHETIC/AdaClip2_Asyn_TestLoss_04flat.txt', 'a+') as fl:
...
with open('../results/SYNTHETIC/AdaClip2_Asyn_TestAcc_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.clipbound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SYNTHETIC/AdaClip2_Asyn_TrainLoss_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, SK is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.clipbound,
                    args.ClipStyle, args.Leaf))
with open('../results/SYNTHETIC/AdaClip2_Asyn_Budget_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, batch_size, args.lr, args.z, args.clipbound,
                    args.ClipStyle, args.Leaf))
...
for itr in range(1, args.itr_numbers + 1):
    ...
    Collect_Models = AddNoise_to_Model(Collect_Models, Clip_Bound, args)  # Noise injection
    # Average indicators
    Collect_Indicator = Collect_Indicator/ (idx_outer+1)
    # Update clipping bound
    Clip_Bound = UpdateClipBound(args, Clip_Bound, lr, Collect_Indicator, style="Lin")
