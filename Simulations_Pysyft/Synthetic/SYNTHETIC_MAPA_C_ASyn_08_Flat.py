...
class Arguments():
    def __init__(self):
        ...
        self.L_smooth = 0.15   # L smooth constant of gradient
...
with open('../results/SYNTHETIC/MAPA_C_Asyn_TestLoss_08flat.txt', 'a+') as fl:
...
with open('../results/SYNTHETIC/MAPA_C_Asyn_TestAcc_08flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, L is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.L_smooth, Stage_Lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SYNTHETIC/MAPA_C_Asyn_TrainLoss_08flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, L is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.L_smooth, Stage_Lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
with open('../results/SYNTHETIC/MAPA_C_Asyn_Budget_08flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, L is {}, LR is{}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.L_smooth, Stage_Lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
