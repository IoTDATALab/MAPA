...
# vis = Visdom(env='SYNTHETIC_MAPA_S_ASyn_04flat')
...
class Arguments():
    def __init__(self):
        ...
        self.L_smooth = 0.238/(1.45*5)   # L smooth constant of gradient
        ...
        self.inital_bound = 100   # Initial estimation of f(x_1)-f(x^*)
...
with open('../results/SYNTHETIC/MAPA_S_Asyn_TestLoss_04flat.txt', 'a+') as fl:
...
with open('../results/SYNTHETIC/MAPA_S_Asyn_TestAcc_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
    fl.write(str(test_acc) + '\t')
with open('../results/SYNTHETIC/MAPA_S_Asyn_TrainLoss_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
with open('../results/SYNTHETIC/MAPA_S_Asyn_Budget_04flat.txt', 'a+') as fl:
    fl.write('\n {} Results \n (UN is {}, SP is {}, BZ is {}, LR is {}, SNR is {}, CB is {}, CS is {}, LF is {})'.
             format(date, Users_num_total, args.user_sel_prob, args.batch_size, args.lr, args.z, args.grad_upper_bound,
                    args.ClipStyle, args.Leaf))
